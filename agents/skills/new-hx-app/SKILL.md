...
1. Layout: `src/{app.js,views.js,paths.js,types.js}`, `serve.js`, `data/` fixtures, `test/*.test.js`, `e2e/*.test.js`, `.github/workflows/ci.yml` (3-line caller of core `js-check.yml`), `.devcontainer/devcontainer.json` from core `templates/hx-app`.
